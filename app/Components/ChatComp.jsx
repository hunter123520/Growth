...
function ChatCompWithVoice({titleshow=true}) {
  const { t } = useTranslation();
  const [text, setText] = useState(t("How can i protect my plants"));
  ...
  return (
    <div style={{ width: "100%" }}>
      {
        titleshow ?<div className='descotitle' style={{ textAlign: "center" }}>
        {t("Plant Diseases")} <span style={{ color: "#578a25" }}>{t("Assistant")}</span>
      </div>
:<></>
      }
