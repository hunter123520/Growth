      ...
      >
        <div className="d-flex flex-column">
          ...
          <Typography
            ...
            lineHeight={1.5}
          >
            {t("We believe in a community that prioritizes healthy plants and a sustainable future. That’s why we created Growth – to empower gardeners, farmers, and plant enthusiasts like you to become disease management champions! Our goals are clear:")}
            <br />
...
<br />
<span style={{ lineHeight: 2 }}>
  <span style={{ color: "rgb(54, 240, 253);" }}>✓</span> {t("Enhance Disease Detection Accuracy")}
</span>
<br />
<span style={{ lineHeight: 2 }}>
  <span style={{ color: "rgb(54, 240, 253);" }}>✓</span> {t("Promote Plant Health Sustainability")}
</span>
<br />
<span style={{ lineHeight: 2 }}>
  <span style={{ color: "rgb(54, 240, 253);" }}>✓</span> {t("Foster a Culture of Smart Plant Care")}
</span>
          ...
          <div className="intro-text-container" style={{width:"100% !important"}}>
            ...
            <div className="intro-content">
              <Typography
                ...
                style={{ marginTop: 10 }}
              >
                {t("Furthermore, we are dedicated to fostering a collaborative and supportive community of plant enthusiasts and AI innovators. We encourage active engagement, questions, and discussions, and we are always excited to connect with like-minded individuals who share our passion for AI-driven plant care. Together, we can build a strong network, exchange ideas, and inspire each other on this fascinating journey toward healthier plants and smarter solutions.")}
